      ...
      <div className="relative mx-auto max-w-6xl px-8">
        ...
        <div className="mx-auto flex max-w-lg flex-col items-center">
          {layers.map((layer, index) => (
            ...
            >
              <div
                className={`w-full rounded-3xl text-center transition-all duration-300 hover:-translate-y-1 border border-white/10 bg-white/[0.03] hover:border-cyan-400/30 hover:bg-white/[0.05] ${
